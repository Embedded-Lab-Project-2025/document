...
% \subsection{Equipment Images}
\begin{figure}[H]
  \centering
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth,height=4cm,keepaspectratio]{assets/equipments/Nucleo_Board_64_DSL.jpg}
    \caption{STM32 Nucleo F411RE Board}
  \end{minipage}
  \hfill
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth,height=4cm,keepaspectratio]{assets/equipments/esp32.jpg}
    \caption{ESP32-S3 Development Board}
  \end{minipage}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth,height=4cm,keepaspectratio]{assets/equipments/dht11.jpg}
    \caption{DHT11 Temperature and Humidity Sensor}
  \end{minipage}
  \hfill
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth,height=4cm,keepaspectratio]{assets/equipments/ldr.jpg}
...
\begin{figure}[H]
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth,height=4cm,keepaspectratio]{assets/equipments/water_level.jpeg}
    \caption{HW-038 Water Level Sensor}
  \end{minipage}
  \hfill
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth,height=4cm,keepaspectratio]{assets/equipments/SG90_2-800x800.jpg}
...
\begin{figure}[H]
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth,height=4cm,keepaspectratio]{assets/equipments/jumper.jpg}
    \caption{Jumper Cable}
  \end{minipage}
  \hfill
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth,height=4cm,keepaspectratio]{assets/equipments/breadboard.jpg}
    \caption{Breadboard}
  \end{minipage}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth,height=4cm,keepaspectratio]{assets/equipments/usb mini cable.jpg}
    \caption{USB Mini Cable}
  \end{minipage}
  \hfill
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth,height=4cm,keepaspectratio]{assets/equipments/usb_c_cable.jpg}
...
\begin{figure}[H]
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth,height=6cm,keepaspectratio]{assets/hardware_setup.jpg}
    \caption{Hardware Setup}
  \end{minipage}
  \hfill
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth,height=6cm,keepaspectratio]{assets/rain_gauge.jpg}
...
The Web Application Subsystem provides a user-friendly interface for monitoring real-time weather data, viewing historical trends, and controlling device functions.
...
\begin{itemize}
  ...
  \item  MQTT URL: \url{ubunsin.krissada.com:1883} (MQTT), \url{https://ws.jarnyam.krissada.com} (WebSocket)
  \item  Backend URL: \url{https://api.jarnyam.krissada.com}
  \item  Web Application URL: \url{https://jarnyam.krissada.com}
\end{itemize}

\section{References}
\subsection{Equipment Images}
\begin{itemize}
  \item STM32 Nucleo F411RE Board: \url{https://th.mouser.com/ProductDetail/STMicroelectronics/NUCLEO-F411RE?qs=Zt3UNFD9mQjdEJg18RwZ2g%3D%3D}
    \item ESP32-S3 Development Board: \url{https://www.amazon.com/YEJMKJ-Development-ESP32-S3-DevKitC-1-N16R8-ESP32-S3-WROOM-1-Microcontroller/dp/B0CRRNLTPD}
    \item DHT11 Temperature and Humidity Sensor: \url{https://www.genlogic.co.th/product/60/dht11-temperature-and-humidity-sensor-module}
    \item Light Dependent Resistor (LDR): \url{https://kitsguru.com/products/photosensitive-resistor-sensor-module-for-arduino}
    \item HW-038 Water Level Sensor: \url{https://www.majju.pk/product/analog-water-level-sensor-module-for-arduino/}
    \item SG90 Servo Motor: \url{https://th.cytron.io/p-sg90-micro-servo}
    \item Jumper Cable: \url{https://www.robotsiam.com/product/16/jumper-f2m-cable-wire-40pcs-2-54mm-20cm-female-to-male}
    \item Breadboard: \url{https://www.pishop.us/product/full-sized-breadboard-830-points/}
    \item USB Mini Cable: \url{https://th.rs-online.com/web/p/usb-cables/1862818}
    \item USB Type-C Cable: \url{https://www.torchdirect.co.uk/products/usb-type-c-to-usb-type-c-1-5-m-data-sync-and-charging-cable}
  \end{itemize}
