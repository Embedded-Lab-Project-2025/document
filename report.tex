...
\begin{itemize}
  ...
  \item \textbf{Topics}:
    \begin{itemize}
      ...
      \item \texttt{sensor/action}: Subscribed by ESP32S3 to receive commands (e.g., resetRainGauge)
    \end{itemize}
\end{itemize}
...
\begin{itemize}
  \item \textbf{Sippakorn:} Project kickoff, repository setup, equipment procurement
...
\begin{itemize}
  ...
  \item \textbf{Thanakrit:} Validate protocols, optimize transmission
...
\begin{itemize}
  ...
  \item \textbf{Krissada:} Load testing, optimize database, deploy production
  \item \textbf{Thanakrit:} Performance validation, finalize documentation
  \item \textbf{Boonyakorn:} Bug fixes, power optimization, code documentation
\end{itemize}
